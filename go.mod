...
replace github.com/btcsuite/btcwallet => github.com/breez/btcwallet v0.16.10-16b422a-breez

replace github.com/btcsuite/btcwallet/walletdb => github.com/breez/btcwallet/walletdb v1.4.0-breez
