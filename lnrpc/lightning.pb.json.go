...
func RegisterLightningJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["lnrpc.Lightning.GetPeerConnected"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &GetPeerConnectedRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.GetPeerConnected(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.GetPeerIdByScid"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &GetPeerIdByScidRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.GetPeerIdByScid(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
