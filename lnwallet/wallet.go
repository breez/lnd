...
func (l *LightningWallet) handleContributionMsg(req *addContributionMsg) {
	...
	// parameters.
	walletLog.Infof("BBBBBB reserve and dust bounds: {our contribution: %+v, dustlimit: %v, chan reserve: %v}, {their contribution: %+v, dustlimit: %v, chan reserve: %v}", pendingReservation.ourContribution, pendingReservation.ourContribution.DustLimit, pendingReservation.ourContribution.ChanReserve, pendingReservation.theirContribution, pendingReservation.theirContribution.DustLimit, pendingReservation.theirContribution.ChanReserve)
...
func (l *LightningWallet) handleSingleContribution(req *addSingleContributionMsg) {
	...
	walletLog.Infof("AAAAAA reserve and dust bounds: {our contribution: %+v, dustlimit: %v, chan reserve: %v}, {their contribution: %+v, dustlimit: %v, chan reserve: %v}", pendingReservation.ourContribution, pendingReservation.ourContribution.DustLimit, pendingReservation.ourContribution.ChanReserve, pendingReservation.theirContribution, pendingReservation.theirContribution.DustLimit, pendingReservation.theirContribution.ChanReserve)
	if !pendingReservation.validateReserveBounds() {
		req.err <- fmt.Errorf("invalid reserve and dust bounds")
		return
	}
